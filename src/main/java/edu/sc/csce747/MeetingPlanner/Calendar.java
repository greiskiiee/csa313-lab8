...
public class Calendar {
    ...
    /**
     * Default constructor, builds a calendar and initializes each day to an
     * empty list.
     */
    public Calendar() {
        /**
         * Create an empty calendar Order of access is month, day, meetingNumber
         * We want to tie 1 to Janaury, 2 to February, etc, so we will index
         * 1-12 for months, 1-31 for days. Times are indexed 0 - 23. Need to
         * check bounds when adding a meeting.
         */
        ...
        /**
         * Not every month should have 31 days. We can deal with this in a
         * hack-ish manner by putting in all-day meetings for those dates.
         */
    ...
    /**
     * Used to check whether a meeting is scheduled during a particular time
     * frame.
     *
